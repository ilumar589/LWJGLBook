...
public final class CoordinateSystemExamples {
    ...
    public static void camera_7_1() {
        ...
        Shader shader = new Shader("/7.1.camera_vs.glsl", "/7.1.camera_fs.glsl");
        ...
        while (!glfwWindowShouldClose(windowHandle)) {
            ...
            float radius = 10.0f;
            double camX = org.joml.Math.sin(glfwGetTime()) * radius;
            double camZ = org.joml.Math.cos(glfwGetTime()) * radius;
            view = view.lookAt(new Vector3f((float) camX, 0.0f, (float) camZ), new Vector3f(0.0f, 0.0f, 0.0f), new Vector3f(0.0f, 1.0f, 0.0f));
